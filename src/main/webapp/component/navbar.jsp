...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
	<div class="container-fluid">
		<a class="navbar-brand" href="index.jsp"><i
			class="fa fa-clinic-medical"></i> MEDI HOME</a>
				...
				<c:if test="${empty userobj }">
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="admin_login.jsp"><i
							class="fas fa-sign-in-alt"></i> Admin Login</a></li>
					<li class="nav-item"><a class="nav-link active"
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="doctor_login.jsp"><i
							class="fas fa-sign-in-alt"></i> Doctor Login</a></li>
					<li class="nav-item"><a class="nav-link active"
				...
				<c:if test="${ not empty userobj}">
					...
					<div class="dropdown">
						<button class="btn btn-primary dropdown-toggle" type="button"
							...
							aria-expanded="false"><i class="fas fa-user-circle"></i> ${ userobj.fullname }</button>
