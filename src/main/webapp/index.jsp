...
<body>
	...
	<div class="container p-3">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<img alt="" src="img/doctor7.png" height="430px" width="360px">
			</div>
	...
	<div class="container p-2">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Shiva Thakur</p>
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/doctor6.avif" width="250px" height="300px">
						<p class="fw-bold fs-5">Dr. Shivani Singh</p>
						<p class="fs-7">(Chief Doctor)</p>
					</div>
				</div>
			</div>
